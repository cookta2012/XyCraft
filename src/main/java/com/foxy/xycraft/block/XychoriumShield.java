...
public class XychoriumShield extends XyBaseBlock {

	public XychoriumShield(String blockName) {
		super(Material.rock);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        icon = new IIcon[2];
        icon[0] = iconRegister.registerIcon(XyCraft.INSTANCE + ":" + "deco/" + "XyShield");
