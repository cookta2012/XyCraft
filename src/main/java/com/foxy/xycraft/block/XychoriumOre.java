	    ...
	    {
	        {
	            ...
	            if (this == XyBlocks.XyOreRed){
	            	j1 = XyItems.XychoriumRed;
	            }
	            if (this == XyBlocks.XyOreDark){
	            	j1 = XyItems.XychoriumDark;
	            }
	            if (this == XyBlocks.XyOreLight){
	            	j1 = XyItems.XychoriumLight;
	            }
